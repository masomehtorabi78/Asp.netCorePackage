$(document).ready(function () {
    ...
    var kanban_board_data = [
        {
            ...
            item: [
                {
                    id: "1_1",
                    title: "اکسپرس مشتری برای سفر بیرونی منظومه شمسی",
                    border: "green",
                    dueDate: "تیر 9, 1401",
                    comment: 1,
                    attachment: 1,
                ...
                {
                    id: "1_2",
                    title: "چیزی را تایپ کنید",
                    border: "orange",
                    image: "../../../app-assets/images/gallery/46.jpg",
                    dueDate: "اسفند 1, 20190"
                },
                {
                    id: "1_3",
                    title: "گرافیک رسانه های اجتماعی",
                    border: "cyan",
                    dueDate: "خرداد 3, 1401",
                    comment: 23,
                    attachment: 1,
                    users: [
                ...
                {
                    id: "1_4",
                    title: "آگهی های روزنامه را به صورت آنلاین در کتاب محبوب رزرو کنید.",
                    border: "red",
                    dueDate: "بهمن 3, 1401",
                    comment: 56,
                    attachment: 1,
        ...
        },
        {
            ...
            item: [
                {
                    id: "2_1",
                    title: "طراحی کیت رابط کاربری مسطح",
                    border: "light-blue"
                },
                {
                    id: "2_2",
                    title: "برای نشان دادن آن، افراد را روی کارت بکشید.",
                    border: "orange",
                    dueDate: "خرداد 1, 1401",
                    comment: 8,
                    users: [
                ...
                {
                    id: "2_4",
                    title: "طراحی لوگو باربیکیو 😱",
                    border: "blue-grey",
                    dueDate: "خرداد 6, 1401",
                    comment: 10,
                    attachment: 1,
                    badgeContent: "AK",
                    badgeColor: "red"
        ...
        },
        {
            ...
            item: [
                {
                    id: "3_1",
                    title: "سیستم مدیریت پایگاه داده (DBMS) مجموعه ای از برنامه ها است",
                    border: "light-blue",
                    dueDate: "شهریور 1, 1401",
                    comment: 10,
                    users: [
                ...
                {
                    id: "3_3",
                    title: "نوار پیشرفت بوت استرپ را با & مشکل برطرف کنید",
                    border: "red",
                    dueDate: "شهریور 9, 1401",
                    users: [
    ...
    var KanbanExample = new jKanban({
        ...
        buttonContent: "+ افزودن یک مورد جدید", // text or html content of the board button
        widthBoard: '300px',
    ...
    addBoardDefault.addEventListener("click", function () {
        ...
        if (kanbanNewBoard) {
            ...
            kanbanNewBoardData = '<div class="dropdown">' +
                ...
                '<li><a href="#!"><i class="material-icons">link</i><span class="menu-item">کپی لینک</span></a></li>' +
                '<li class="kanban-delete"><a href="#!"><i class="material-icons">delete</i><span class="menu-item">حذف</span></a></li>' +
                '</ul></div>';
